...
<body class="body-wrapper">    
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-5 col-md-6 text-center text-md-start">
                    <div class="top-welcome-text">
                        <p>welcome to no. 1 transport solutions</p>
                    </div>
                </div>
                <div class="col-lg-5 mt-3 mt-md-0 col-md-6 text-center text-md-end d-flex justify-content-end align-items-center">
            ...
            <div class="row middle-bar justify-content-between align-items-center">
                <div class="col-xl-3 col-lg-12 col-6 text-lg-center text-xl-start">
                    <div class="logo mb-lg-4 mb-xl-0">
                        <a href="index.html"><img src="assets/img/logo.png" alt="transland"></a>
                    </div>
                </div>
    ...
    <section class="hero-wrapper hero-2">
        <div class="hero-slider-2">
            <div class="single-slide bg-cover" style="background-image: url('assets/img/home2/slide1.jpg')">
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-xxl-6 col-md-8">
                            <div class="hero-contents">
                                <h1 class="fs-lg animated" data-animation-in="fadeInUp" data-delay-in="0.1">Quick <span>Transport</span></h1>
                                <p class="pe-lg-5 animated" data-animation-in="fadeInUp" data-delay-in="0.5">We are Trusted 15+ Countries Worldwide We hire and build your own remote dedicated development teams tailored to your specific needs.</p>
                                <a href="contact.html" class="theme-btn me-sm-4 " data-animation-in="fadeInUp" data-delay-in="0.8">get a quote <i class="fal fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="single-slide bg-cover" style="background-image: url('assets/img/home2/slide2.jpg')">
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-xxl-6 col-md-8">
                            <div class="hero-contents">
                                <h1 class="fs-lg animated" data-animation-in="fadeInUp" data-delay-in="0.1">Fastest <span>Transport</span></h1>
                                <p class="pe-lg-5 animated" data-animation-in="fadeInUp" data-delay-in="0.5">We are Trusted 15+ Countries Worldwide We hire and build your own remote dedicated development teams tailored to your specific needs.</p>
                                <a href="contact.html" class="theme-btn me-sm-4 " data-animation-in="fadeInUp" data-delay-in="0.8">get a quote <i class="fal fa-long-arrow-right"></i></a>
                            </div>
                        </div>
    ...
    <div class="services-bar-wrapper">
        <div class="container">
                    ...
                    <div class="col-sm-6 col-12 border-right col-md-4 col-xl-2">
                        <div class="single-service-icon">
                            <div class="content">
                                ...
                                <div class="title">
                                    <h6><a href="services-details.html">road freight</a></h6>
                                </div>
                            </div>
                            <a href="services-details.html" class="service-link"><i class="fal fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="col-sm-6 col-12 border-right col-md-4 col-xl-2">
                        <div class="single-service-icon">
                            <div class="content">
                                ...
                                <div class="title">
                                    <h6><a href="services-details.html">air freight</a></h6>
                                </div>
                            </div>
                            <a href="services-details.html" class="service-link"><i class="fal fa-long-arrow-right"></i></a>
                        </div>
                    ...
                    <div class="col-sm-6 col-12 border-right col-md-4 col-xl-2">
                        <div class="single-service-icon">
                            <div class="content">
                                ...
                                <div class="title">
                                    <h6><a href="services-details.html">ocean freight</a></h6>
                                </div>
                            </div>
                            <a href="services-details.html" class="service-link"><i class="fal fa-long-arrow-right"></i></a>
                        </div>
                    ...
                    <div class="col-sm-6 col-12 border-right col-md-4 col-xl-2">
                        <div class="single-service-icon">
                            <div class="content">
                                ...
                                <div class="title">
                                    <h6><a href="services-details.html">train freight</a></h6>
                                </div>
                            </div>
                            <a href="services-details.html" class="service-link"><i class="fal fa-long-arrow-right"></i></a>
                        </div>
                    ...
                    <div class="col-sm-6 col-12 border-right col-md-4 col-xl-2">
                        <div class="single-service-icon">
                            <div class="content">
                                ...
                                <div class="title">
                                    <h6><a href="services-details.html">drone freight</a></h6>
                                </div>
                            </div>
                            <a href="services-details.html" class="service-link"><i class="fal fa-long-arrow-right"></i></a>
                        </div>
                    ...
                    <div class="col-sm-6 col-12 border-right col-md-4 col-xl-2">
                        <div class="single-service-icon">
                            <div class="content">
                                ...
                                <div class="title">
                                    <h6><a href="services-details.html">send gift</a></h6>
                                </div>
                            </div>
                            <a href="services-details.html" class="service-link"><i class="fal fa-long-arrow-right"></i></a>
                        </div>
    ...
    <section class="about-us-wrapper section-padding">
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="about-img-gallery me-lg-5 mb-5 mb-lg-0">
                        ...
                        <div class="about-img-center bg-cover" style="background-image: url('assets/img/home2/about-center.jpg')">
                        </div>
                ...
                <div class="col-lg-6 col-12">
                    ...
                    <p>Denounce with righteous indignation and dislike men who are beguiled likes and demoralized by the charms off pleasures of the moments</p>
                    <div class="row">
                    ...
                    <div class="about-ceo d-sm-flex align-items-center wow fadeInUp" data-wow-delay=".7s">
                        <div class="ceo-img bg-cover" style="background-image: url('assets/img/home2/ceo.jpg')"></div>
                        <div class="ceo-info">
                            <h5>Alexis D. Denzol</h5>
                            <span>CEO & Founder, Transland</span>
                        </div>
                        <div class="autograph-signature"><img src="assets/img/home2/signature.png" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="brand-carousel-active section-padding pb-0">
    ...
    <section class="funfact-wrapper section-padding">
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-12">
                    <div class="section-title-2">
                        <span>Fun fact</span>
                        <h1>Magnificient Quality Gives You an Edge</h1>
                    </div>
                    <div class="tab-wrapper">
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                              <button class="nav-link active" id="pills-noise-tab" data-bs-toggle="pill" data-bs-target="#pills-noise" type="button" role="tab" aria-controls="pills-noise" aria-selected="true">Noise isolation</button>
                            </li>
                            <li class="nav-item" role="presentation">
                              <button class="nav-link" id="pills-energy-tab" data-bs-toggle="pill" data-bs-target="#pills-energy" type="button" role="tab" aria-controls="pills-energy" aria-selected="false">Energy efficiency</button>
                            </li>
                          </ul>
                          <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-noise" role="tabpanel" aria-labelledby="pills-home-tab">
                                <div class="tab-contents">
                                    <p>Step forward to become one of 49,494 successful clients of transland and
                                        get in the front line with some shit shat.</p>
                                    <div class="single-funfact-digit">
                                        <h2>35</h2>
                                        <p>Noise isolation</p>
                                    </div>
                                    <div class="single-funfact-digit">
                            ...
                            <div class="tab-pane fade" id="pills-energy" role="tabpanel" aria-labelledby="pills-profile-tab">
                                <div class="tab-contents">
                                    <p>Step forward to become one of 49,494 successful clients of transland and get in the front line with some shit shat.</p>
                ...
                <div class="col-xl-6 col-12 ps-xl-5">
                    <div class="funfact-img ms-xl-5 mt-5 mt-xl-0">
                        <img src="assets/img/home2/fact-img.jpg" alt="transland">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-3 col-md-6 col-12">
                    <div class="single-team-member bg-cover" style="background-image: url('assets/img/team/5.jpg')">
                        <div class="member-details">                            
                            <span>Founder</span>
                            <h3><a href="team-details.html">Salman Ahmed</a></h3>
                        </div>
                ...
                <div class="col-xl-3 col-md-6 col-12">
                    <div class="single-team-member bg-cover" style="background-image: url('assets/img/team/6.jpg')">
                        <div class="member-details">                            
                            <span>CEO</span>
                ...
                <div class="col-xl-3 col-md-6 col-12">
                    <div class="single-team-member bg-cover" style="background-image: url('assets/img/team/7.jpg')">
                        <div class="member-details">                            
                            <span>Desginer</span>
                            <h3><a href="team-details.html">Alex D. Denzilan</a></h3>
                        </div>
                        <div class="social-icons">
                            <div class="plus-icon"><i class="fal fa-plus"></i></div>
                            <div class="top">
                ...
                <div class="col-xl-3 col-md-6 col-12">
                    <div class="single-team-member bg-cover" style="background-image: url('assets/img/team/8.jpg')">
                        <div class="member-details">                            
                            <span>Support Engineer</span>
                            <h3><a href="team-details.html">Kilmon L. Limona</a></h3>
                        </div>
                        <div class="social-icons">
                            <div class="plus-icon"><i class="fal fa-plus"></i></div>
                            <div class="top">
    ...
    <section class="testimonial-wrapper section-padding">
        <div class="container">
            <div class="row">
                <div class="col-12 col-xl-4 text-center text-lg-start col-lg-5 pe-lg-0">
                    <div class="section-title-2 mb-10">
                        <span>testimonials</span>
                        <h1>People Say About us</h1>
                    </div>
                    <p>Transland is the world’s driving worldwide coordinations supplier — we uphold industry and exchange the worldwide trade.</p>
                    <a href="testimoinals.html" class="theme-btn mt-30">All testimonials</a>
                </div>
                <div class="col-lg-7 col-xl-8 col-12 mt-5 mt-lg-0">
                    <div class="testimonial-carousel-active ps-xl-5 pe-xl-5">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mt-5 mt-lg-0">
                    <div class="featured-video-wrapper text-center d-flex justify-content-center align-items-center bg-cover" style="background-image: url('assets/img/faq-video-pup.jpg')">
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6">
                    <div class="single-blog-item">
                        ...
                        <div class="content">
                            <h3><a href="news-details.html">Helping Companies in Their Green Transition</a></h3>
                            <p>With the cargo business blasting, financier firms are bouncing</p>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="single-blog-item">
                        <div class="post-featured-thumb bg-cover" style="background-image: url('assets/img/blog/b7.jpg')">
                            <div class="post-cat">
                        ...
                        <div class="content">
                            ...
                            <div class="post-meta d-flex align-items-center">
                                <div class="post-date">
                                    <i class="fal fa-calendar-alt"></i>Jan 25, 2022
                                </div>
                                <div class="post-author">
                                    <i class="fal fa-user-alt"></i> by <a href="#">admin</a>
                                </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="single-blog-item">
                        <div class="post-featured-thumb bg-cover" style="background-image: url('assets/img/blog/b5.jpg')">
                            <div class="post-cat">
                                <a href="news.html">package</a>
                            </div>
                        </div>
                        <div class="content">
                            <h3><a href="news-details.html">Drivers Deliver Much More Than Products</a></h3>
                            <p>With the cargo business blasting, financier firms are bouncing</p>

                            <div class="post-meta d-flex align-items-center">
                                <div class="post-date">
                                    <i class="fal fa-calendar-alt"></i>Feb 14, 2022
                                </div>
                                <div class="post-author">
                                    <i class="fal fa-user-alt"></i> by <a href="#">admin</a>
                                </div>
    ...
    <footer class="footer-wrap footer-2 bg-cover text-white bg-overlay" style="background-image: url('assets/img/footer-bg.jpg')">
